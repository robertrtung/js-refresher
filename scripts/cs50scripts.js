...
function addMarker(place)
{
    ...
    marker.addListener('click', function(){
        ...
        var article = "https://ide50-rrt23.cs50.io/articles.php?geo=" + place["postal_code"];
...
function configure()
{
    ...
    },
    {
        ...
        templates: {
            ...
            suggestion: _.template("<p><%- place_name %>, <%- admin_name1 %></p><p style='color:grey'><%- postal_code %></p>")
        }
    });
